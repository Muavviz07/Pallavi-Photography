...
from app.api.routes import auth, health, galleries, client_galleries, admin, blogs, bookings, enquiries, newsletter, testimonials, hero_slides, recognitions_awards, about, pricing, faqs, contact, media, admin_images, client_medias
...
api_router.include_router(client_medias.router)
